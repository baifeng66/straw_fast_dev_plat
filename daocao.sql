...
VALUES (1, 0, '首页', 0, 0, '/index', 'index', 'index', '', 0, 0, 'admin', 'admin', '2023-12-11 18:57:19',
        '2023-12-11 18:57:21');
INSERT INTO `ums_menu`
VALUES (2, 0, '系统管理', 1, 0, 'system', 'system', 'system', '', 0, 0, 'admin', 'admin', '2023-12-11 18:58:23',
        '2023-12-11 18:58:25');
INSERT INTO `ums_menu`
VALUES (3, 0, '系统工具', 2, 0, 'tools', 'tools', 'tools', '', 0, 0, 'admin', 'admin', '2023-12-11 18:58:53',
        '2023-12-11 18:58:55');
INSERT INTO `ums_menu`
VALUES (4, 0, '支付管理', 3, 0, 'pay', 'pay', 'pay', '', 0, 0, 'admin', 'admin', '2023-12-11 18:59:30',
        '2023-12-11 18:59:32');
INSERT INTO `ums_menu`
VALUES (5, 2, '用户管理', 4, 1, 'system/user/index', 'sysUser', 'system:user:list', '', 0, 0, 'admin', 'admin',
        '2023-12-11 19:01:16', '2023-12-11 19:01:18');
INSERT INTO `ums_menu`
VALUES (6, 2, '角色管理', 5, 1, 'system/role/index', 'sysRole', 'system:role:list', '', 0, 0, 'admin', 'admin',
        '2023-12-11 19:02:05', '2023-12-11 19:02:08');
INSERT INTO `ums_menu`
VALUES (7, 2, '菜单管理', 6, 1, 'system/menu/index', 'sysMenu', 'system:menu:list', '', 0, 0, 'admin', 'admin',
        '2023-12-11 19:02:52', '2023-12-11 19:02:55');
INSERT INTO `ums_menu`
VALUES (8, 3, '代码生成', 7, 1, 'tools/gen/index', 'toolsGen', 'tools:gen:list', '', 0, 0, 'admin', 'admin',
        '2023-12-11 19:03:57', '2023-12-11 19:04:00');
INSERT INTO `ums_menu`
VALUES (9, 5, '新增用户', 8, 2, NULL, NULL, 'sysem:user:add', '', 0, 0, 'admin', 'admin', '2023-12-11 19:04:50',
        '2023-12-11 19:04:52');
...
VALUES (1, 'admin', 'admin', 0, 0, 0, NULL, 'admin', 'admin', '2023-12-11 19:08:39', '2023-12-11 19:08:42');
INSERT INTO `ums_role`
VALUES (2, 'developer', '开发者', 1, 0, 0, NULL, 'admin', 'admin', '2023-12-11 19:08:45', '2023-12-11 19:08:47');
...
(
  ...
  AUTO_INCREMENT = 1732769264547377155
  CHARACTER SET = utf8mb4
...
VALUES (1, 'admin', 'admin', 'xiaoli@feidao.com', '123456789', 0, 'avatarurl',
        '$2a$10$pRwnzWnbVnhAhR8DBzvfrujFzguinBp13siEApFgasTbvqJxi3nrq', 0, 'admin', '2023-12-07 22:29:21', 'admin',
        '2023-12-07 22:29:21', '备注', 0);
INSERT INTO `ums_sys_user`
VALUES (1732769264547377154, 'zs', '张三', 'zhangsan@123.com', '16632156458', 0,
        'https://himg.bdimg.com/sys/portraitn/item/public.1.fc4cce31.XtVbJS1kKdVpCfCbNXODUw',
        '$2a$10$pRwnzWnbVnhAhR8DBzvfrujFzguinBp13siEApFgasTbvqJxi3nrq', 0, 'admin', '2023-12-11 19:06:41', 'admin',
        '2023-12-11 19:06:46', NULL, 0);
...
VALUES (1, 1, 1);
INSERT INTO `ums_sys_user_role`
VALUES (2, 1732769264547377154, 2);
